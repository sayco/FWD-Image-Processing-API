...
describe("Testing Image Resizing API", () => {
    ...
    it("responds to /resize with file name and width only", function () {
        return request.get(`/api/resize?filename=udacity&width=300`).expect("content-type", "image/jpeg");
    });
    ...
    it("responds to /resize with file name and height only", function () {
        return request.get(`/api/resize?filename=udacity&height=290`).expect("content-type", "image/jpeg");
    });
    ...
    it("responds to /resize with file name and height and width", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request.get(`${resizeEndpoint}?filename=${resizeFilename}&width=260&height=260`);
